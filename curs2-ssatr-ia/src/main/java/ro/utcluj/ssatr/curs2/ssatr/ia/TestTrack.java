...
public class TestTrack {
   ...
   String getAllCarsDetails(){
       ...
       for(Car c: cars){ 
           if(c!=null){
            String line = "Car name="+c.getName()+" speed="+c.speed+ "PLATE NUMEBR"+c.getplateNumber()+"\n";
            all=all+line;
           }
       }
       return all;
    ...
    public static void main(String[] args) {
        ...
        track1.addCar(new ElectricCar("Tesla 1", 0,"CJ29ASD"));
        track1.addCar(new ElectricCar("Tesla 2", 0,"CJ29ASD"));
        track1.addCar(new OttoCar("Opel 2", 0,"CJ29ASD"));
        track1.addCar(new DieselCar("Tesla 2", 0,"CJ29ASD"));
        track1.addCar(new DieselCar("Tesla 2", 0,"CJ29ASD"));
